...
org_abac_attributes = {
    "UNR-CSE": ["UNR", "CICI-Affiliate", "Research"],
    "UNR-RC": ["UNR", "IT-Ops", "Research"],
...
def cpabe_keys_by_org(cpabe_alg):
    ...
    try:
        ...
        #print("type:",type(cpabe_alg.serialize_charm_obj(mk)))
...
cpabe_secretkey = secret_keychain_bsw07["UNR-CISO"]
